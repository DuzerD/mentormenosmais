    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-primary via-blue-600 to-indigo-700 py-24 text-white">
      ...
      <div className="container relative z-10 mx-auto max-w-4xl px-4 text-center">
        <h2 className="text-balance text-4xl font-bold md:text-6xl">
          Saia do modo “fazer tudo sozinho” e recupere o controle do seu tempo
        </h2>
        <p className="mt-6 text-xl text-white/90">
          A maioria dos empreendedores acredita que precisa fazer tudo para dar certo. A verdade é que crescimento
          sustentável vem quando você foca no que importa e cria um sistema que trabalha por você.
        </p>

        <div className="mt-10 space-y-4 text-lg text-white/90">
          <p>O Mentoor entrega clareza, foco e tempo para você viver melhor o que construiu.</p>
        </div>

        <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <Button size="lg" className="bg-white px-8 text-lg text-primary hover:bg-gray-100" asChild>
            <Link href="/onboarding">
              Quero simplificar meu negócio agora
        ...
        <div className="mt-12 flex flex-wrap items-center justify-center gap-8 text-sm text-white/90">
          ...
          <span className="flex items-center gap-2">
            <Check className="h-5 w-5" />
            Resultados com clareza, não correria
          </span>
        </div>
      </div>
